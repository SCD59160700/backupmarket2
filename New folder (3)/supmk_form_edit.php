                ...
                <div class="row">
                  ...
                  <div class="col-lg-7 mx-auto">
                    <div class="p-5 ">
                      ...
                      <form class="user" action="code/supmk_form_edit_db.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="mk_id" value="<?php echo $mk_id; ?>">
                        <input type="hidden" name="mk_img" value="<?php echo $mk_img; ?>">
                        <div class="form-group">
                          <div class="col-sm-2" align="right"> รูป </div>
                          <div class="col-sm-3" align="left">
                            <input type="file" name="mk_img" />
                          </div>
                        </div>
                        <br>
                        <div class="form-group ">
                          <!-- <div class="col-sm-6 mb-3 mb-sm-0"> -->
                          <input name="mkname" type="text" class="form-control form-control" placeholder="ชื่อตลาด" value="<?= $mk_name; ?>">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-4" align="left">
                            <select name="type" class="form-control">
                              <option value="ตลาดนัด" <?php
                                                      if ($mk_type == 'ตลาดนัด') {
                                                        echo "selected";
                                                      }
                                                      ?>>ตลาดนัด</option>
                              <option value="ตลาดสด" <?php
                                                      if ($mk_type == 'ตลาดสด') {
                                                        echo "selected";
                                                      }
                                                      ?>>ตลาดสด</option>
